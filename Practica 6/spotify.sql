...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-02-2026 a las 16:03:49
...
INSERT INTO `playlists` (`id_playlist`, `nombre`, `n_canciones`, `duracion`, `usuario_id`) VALUES
(1, 'La Mas Perrona', 2, '9:05', 1),
(2, 'Puro Estilo Regetón', 1, '3:15', 2),
(3, 'Solo Michael Jackson', 1, '5:40', 3);
...
--
ALTER TABLE `playlist-canciones`
  ADD CONSTRAINT `playlist-canciones_ibfk_1` FOREIGN KEY (`id_cancion`) REFERENCES `canciones` (`id_cancion`),
  ADD CONSTRAINT `playlist-canciones_ibfk_2` FOREIGN KEY (`id_playlist`) REFERENCES `playlists` (`id_playlist`);
